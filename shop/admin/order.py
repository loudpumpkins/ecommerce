...
class OrderPaymentInline(admin.TabularInline):
	...
	def get_formset(self, request, obj=None, **kwargs):
		"""
		Convert the field `payment_method` into a select box with all possible
		payment methods.
		"""
	...
	def get_amount(self, obj):
		...
		return obj.amount
	get_amount.short_description = _("Amount Paid")
...
class OrderItemInline(admin.StackedInline):
	...
	readonly_fields = ['product_code', 'quantity', 'unit_price', 'line_total',
					   'render_as_html_extra']
	...
	def render_as_html_extra(self, obj):
		item_extra_template = select_template([
			'shop/admin/orderitem-{}-extra.html'.format(obj.product.product_model),
...
class BaseOrderAdmin(FSMAdminMixin, admin.ModelAdmin):
	...
	get_outstanding_amount.short_description = _("Outstanding amount")
