...
FSM_SUBMIT_BUTTON_TEMPLATE = 'fsm/fsm_submit_button.html'
FSM_SUBMIT_LINE_TEMPLATE = 'fsm/fsm_submit_line.html'
FSM_TRANSITION_HINTS = 'fsm/fsm_transition_hints.html'
